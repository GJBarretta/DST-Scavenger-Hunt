...
local ItemSlot = Class(Widget, function(self, atlas, bgim, owner)
	...
	if slotColor == 2 then
		self.bgimage:SetTint(0.145,0.4549,0.6627,2) --blue
	elseif slotColor == 3 then
		self.bgimage:SetTint(.1,.88,.6,0.7)	--green
	elseif slotColor == 4 then
		self.bgimage:SetTint(0.96,0.67,0.207,1) --yellow
	elseif slotColor == 5 then
		self.bgimage:SetTint(0.96,0.67,0.207,1) --golden
	elseif slotColor == 6 then
		self.bgimage:SetTint(.219,.556,.556,0.7) -- teal
	elseif slotColor == 7 then
		self.bgimage:SetTint(0.902,0.494,0.133,.75) -- orange
	elseif slotColor == 8 then
		self.bgimage:SetTint(0.464,0.345,0.908,1) -- purple
	elseif slotColor == 9 then
